...
[System.Serializable]
public class FollowerStatblock : MonoBehaviour, ICombatant
{
    #region Follower Data
    [Tooltip("The follower's internal ID")]
    public string followerID;
    [Tooltip("the follower's name as is displayed in game.")]
    public string displayName;

    [Tooltip("The teamID of the follower")]
    public int teamID = 0;
    ...
    [Tooltip("Additonal vigor the follower gained from bonuses.")]
    public float bonusVigor = 0f;

    [Header("Skill Info")]
    [Tooltip("The list of skill components attached to this follower.")]
    ...
    {
        GetComponent<FollowerAI>().TakeTurn();
        actionProgress = 0;
    }
